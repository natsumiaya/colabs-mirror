export const statistic_data = [
  {
    amount: "28",
    description: "Ideas Supported",
  },
  {
    amount: "13",
    description: "Impact Scholarships Awarded",
  },
  {
    amount: "65%",
    description: "Of plants here double as lab assistans",
  },
  {
    amount: "95%",
    description: "Chance of running into a punny scientist",
  },
  {
    amount: "2200kg",
    description: "Of science equipment dierted from landfill",
  },
];

export const community_summary_data = [
  `A Field Guide to <em>Transdisciplinary Innovation.</em>`,
  `<em>Triskelion</em>. A monthly newsletter covering biotech news and articles from within the Co-Labs community and beyond.`,
  `Why We're Supporting the Development of a <em> Cultivated Meat </em> Industry in Australia`,
  `Why We Need to Rethink Our <em> Worldview. </em>`,
  `<em> Biomimicry: </em> Learning from Nature's Genius`,
  `<em> Ecoliteracy: </em> Our Key to a Sustainable Future`,
];

export const service_showcase_data = [
  {
    title: "Lab Space",
...
export const principle_data = [
  {
    title: "We believe biology is the future of technology",
    link: "https://colabs.com.au/our-principles",
    image: "principle/1.jpg",
  },
  {
    title: "Join a thriving ecosystem that supports big ideas",
    link: "https://colabs.com.au/services",
    image:
      "https://colabs.yourcreative.com.au/wp-content/uploads/2023/07/bigideas.jpg",
  },
  {
    title: "Learn, Imagine, Explore – Tune into our podcast",
    link: "https://thestrangeattractor.com.au/",
    image:
      "https://colabs.yourcreative.com.au/wp-content/uploads/2023/08/Fern.png",
  },
];
